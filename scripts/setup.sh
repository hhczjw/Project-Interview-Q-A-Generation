...
deploy_claude_code() {
  ...
  cp "$ADAPTERS_DIR/claude-code/skill.md" "$target_dir/skills/generate-resume.md"
  echo "  ✅ Claude Code Skill 已部署到 $target_dir/skills/generate-resume.md"
}
...
echo ""
echo "使用方式："
echo "  - Claude Code: 在项目中执行 /generate-resume"
echo "  - Cursor: 在对话中说 '生成简历' 或 '根据项目写简历'"
echo "  - Windsurf: 在对话中说 '生成简历'"
echo "  - Copilot: 在对话中说 '生成简历'"
echo "  - Trae: 在对话中说 '生成简历'"
